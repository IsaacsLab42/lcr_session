...
> [Documentation](https://readthedocs.org/projects/lcr-session/).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/IsaacsLab42/lcr_session/issues) that might help you. In case
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  [documentation](https://readthedocs.org/projects/lcr-session/). If you are looking for
...
- To see if other users have experienced (and potentially already solved) the same issue
  ...
  error in the [bug
  tracker](https://github.com/IsaacsLab42/lcr_sessionissues?q=label%3Abug).
...
> bugs must be sent by email to <14634+IsaacsLab42@users.noreply.github.com>.
<!-- You may add a PGP key to allow the messages to be sent encrypted as well. -->

We use GitHub issues to track bugs and errors. If you run into an issue with the
project:

- Open an [Issue](https://github.com/IsaacsLab42/lcr_session/issues/new). (Since we
...
This section guides you through submitting an enhancement suggestion for LCR Session,
...
- Make sure that you are using the latest version.
- Read the [documentation](https://readthedocs.org/projects/lcr-session/) carefully and
  find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/IsaacsLab42/lcr_session/issues) to see if the
...
- **Explain why this enhancement would be useful** to most LCR Session users. You may
